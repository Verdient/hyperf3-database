...
class CastManager
{
    ...
    {
        if (!empty(static::$casts[$connectionName][$tableName])) {
            return static::$casts[$connectionName][$tableName];
        }
        $casts = [];
        ...
        if (!isset(static::$casts[$connectionName])) {
            static::$casts[$connectionName] = [];
        }
        static::$casts[$connectionName][$tableName] = $casts;
        return $casts;
    }
